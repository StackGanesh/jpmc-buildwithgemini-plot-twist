...
base_instruction = (
    ...
    "\n5. In your response, present the complete book concept, the generated A2UI concept poster card, and explicitly output:"
    "\n   - [Tech Proof] Google Cloud Storage Public URL: <exact https URL from tool response>"
    "\n   - [Tech Proof] Google Cloud Firestore Saved Entry ID: <exact Firestore ID from tool response>"
